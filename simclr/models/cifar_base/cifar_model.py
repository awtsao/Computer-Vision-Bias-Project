...
if __name__ == '__main__':
    ...
    finetune_label_path = "../../../data/cifar_train_labels"
    '''
    if fine_tune == 'color':
        color = "color"
        finetune_data_path = "../../../data/cifar_color_train_imgs"
        finetune_label_path = "../../../data/cifar_train_labels"
    elif fine_tune == 'gray':
        color = "gray"
        finetune_data_path = "../../../data/cifar_gray_train_imgs"
        finetune_label_path = "../../../data/cifar_train_labels"
    elif fine_tune == 'cifar-s':
        color = 'cifar-s'
        finetune_data_path = "../../../data/cifar-s/p95.0/train_imgs"
        finetune_label_path = "../../../data/cifar_train_labels"
    '''
    ...
    model = CifarBase(pretrained_path=model_path, testing=False).cuda()
    print('===================MODEL ENCODER=================')
