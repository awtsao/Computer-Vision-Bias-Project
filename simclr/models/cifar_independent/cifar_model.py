...
class CifarIndependent(nn.Module):
    def __init__(self, pretrained_path, testing):
        super(CifarIndependent, self).__init__()
...
if __name__ == '__main__':
    ...
    # Split training data into finetune and validate
    ...
    #Initialize model, freeze simclr weights, only train fc layer
    model = CifarIndependent(pretrained_path=model_path, testing=False).cuda()
